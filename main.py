...
def experiment(args, preload_responses=False, preload_uncertainty=False, preload_accuracy=False, preload_calibration = False, save_results=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_test", type=int, default=100, help="The number of validation samples to test")
